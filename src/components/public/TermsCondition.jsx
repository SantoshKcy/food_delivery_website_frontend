            ...
            <div className="max-w-4xl mx-auto p-6 bg-white mt-10">
                ...
                <div className="space-y-6 text-gray-700">
                    <section>
                        ...
                        <p>
                            Welcome to <strong>Hunger End</strong>. By accessing and using our services, you agree to comply
                    ...
                    <section>
                        ...
                        <p>To use Hunger End, you must:</p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold mb-2">3. Ordering & Payment</h2>
                        <ul className="list-disc pl-5">
                            <li>Orders placed through Hunger End are subject to availability.</li>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold mb-2">4. Delivery & Refund Policy</h2>
                        <ul className="list-disc pl-5">
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5">
                            ...
                            <li>Respect our delivery partners and customer support team.</li>
                            <li>Maintain confidentiality of your account details.</li>
                        </ul>
                    </section>

                    <section>
                        <h2 className="text-xl font-semibold mb-2">6. Account Suspension</h2>
                        <p>
                    ...
                    <section>
                        ...
                        <p>
                            Hunger End is not liable for any direct, indirect, incidental, or consequential damages
