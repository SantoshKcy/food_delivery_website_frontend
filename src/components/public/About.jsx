                ...
                <div className="space-y-6 text-gray-700">
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            food lovers with their favorite restaurants.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-none space-y-2">
                            ...
                            <li className="flex items-center gap-2">
                                <FaUtensils className="text-red-500" /> <strong>Wide Range of Restaurants</strong> – From local favorites to global cuisines.
                            </li>
                            <li className="flex items-center gap-2">
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            dedicated to making your dining experience effortless and enjoyable. From selecting the
                            best restaurants to ensuring on-time deliveries, we put customer satisfaction first.
                        </p>
                    </section>
