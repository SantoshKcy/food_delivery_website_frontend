                        ...
                        <>
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full border-collapse">
                                    ...
                                    <tbody>
                                        {cartItems.map((item) => (
                                            <tr key={`${item.itemId._id}-${item._id}`}>
                                                ...
                                                <td className="p-3 text-center">
                                                    <div className="flex items-center justify-center">
                                                        ...
                                                        <span className="w-12 py-1 text-center border-t border-b flex items-center justify-center">
                                                            {item.quantity}
                                                        </span>
                                                        <button
                            ...
                            <div className="mt-6 flex justify-end">
                                <div className="bg-gray-100 p-6 rounded-lg shadow-md w-full sm:w-1/3">
                                    ...
                                    {/* Checkout Button */}
                                    <button className="w-full mt-6 bg-[#ff7918] text-white  px-6 py-3 rounded-lg shadow-md hover:bg-[#e66b14] transition" onClick={handleProceedToCheckout}>
                                        Proceed to Checkout
                                    </button>
                                </div>
                            </div>
