            ...
            <div className="max-w-4xl mx-auto p-6 bg-white mt-10">
                ...
                <div className="space-y-6 text-gray-700">
                    <section>
                        ...
                        <p>
                            At <strong>Hunger End</strong>, we understand that plans change. If you need to cancel an order,
                            please review our cancellation policy below.
                        </p>
                    </section>

                    <section>
                        <h2 className="text-xl font-semibold mb-2">2. Order Cancellation</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold mb-2">3. Non-Cancelable Orders</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold mb-2">4. Cancellation Fees</h2>
                        <p>
