            ...
            <div className="max-w-4xl mx-auto p-6 bg-white  mt-10">
                ...
                <div className="space-y-6 text-gray-700">
                    <section>
                        ...
                        <p>
                            At <strong>Hunger End</strong>, we strive to provide the best food delivery experience. However,
                    ...
                    <section>
                        <h2 className="text-xl font-semibold mb-2">5. Payment Reversal</h2>
                        <p>
